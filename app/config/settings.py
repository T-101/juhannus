...
Generated by 'django-admin startproject' using Django 2.1.7. Upgraded to Django 4.2.5 in September 2023
...
INSTALLED_APPS = [
    ...
    # apps
    'juhannus',
    # there was a reason why this gets loaded last, but I cannot remember why
